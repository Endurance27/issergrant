...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    roles: ["Researcher (PI)", "Researcher (Co-PI)", "Director"],
  },
  {
    id: "proposals",
    label: "Proposals",
  ...
  },
  {
    ...
    roles: ["Admin", "Finance Officer", "Director"],
  },
  {
    id: "reports",
    label: "Reports",
  ...
  },
  {
    ...
    label: "Team Members",
    icon: <Users size={18} />,
    roles: ["Admin", "Researcher (PI)", "Director"],
  },
  {
    id: "settings",
    label: "Settings",
...
const navSections = [
  ...
  {
    label: "Grants",
    ids: ["grant-calls", "proposals", "awards", "milestones"],
  },
