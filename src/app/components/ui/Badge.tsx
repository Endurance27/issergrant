const statusConfig: Record<string, { bg: string; text: string; dot: string }> =
  {
    ...
    "Researcher (PI)": { bg: "#EAF0F6", text: "#2D6EA8", dot: "#2D6EA8" },
    "Researcher (Co-PI)": { bg: "#F7F3EC", text: "#8C7040", dot: "#B79A64" },
    "Finance Officer": { bg: "#EDECEB", text: "#403C3A", dot: "#403C3A" },
    Director: { bg: "#EAF0F6", text: "#1A3363", dot: "#1A3363" },
  };
...
export function Badge({ status, size = "md" }: BadgeProps) {
  ...
  return (
    ...
    >
      <span
        className="rounded-full flex-shrink-0 size-[5px]"
