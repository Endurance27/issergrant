...
export function FundingDistributionChart() {
  return (
    <SectionCard title="Funding Distribution" subtitle="Awarded amounts by category">
      <ResponsiveContainer width="100%" height={150}>
        <PieChart>
          <Pie
            data={analyticsData.fundingByCategory}
            cx="50%"
            cy="50%"
            innerRadius={42}
            outerRadius={66}
            ...
            dataKey="value"
          >
            {analyticsData.fundingByCategory.map((entry, i) => (
