...
import { CREATE_FUNDING_CALL_MUTATION } from '../gql/mutations/createFundingCall'
import type { CreateFundingCallInput, CreateFundingCallResponse } from '../types/fundingCall.types'

export function useCreateFundingCall() {
  const [error, setError] = useState<Error | null>(null)

  const [mutate, { loading, data }] = useMutation<CreateFundingCallResponse, { content: CreateFundingCallInput }>(
